...
final class FirstPostViewController: UIViewController {
    ...
    private let descriptionLabel = UILabel().createLabel(text: "Задача организации, в особенности же постоянное информационно-техническое обеспечение нашей деятельности требует от нас системного анализа системы масштабного изменения ряда параметров!", size: 15, weight: .semibold, color: .white)
