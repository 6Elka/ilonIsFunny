...
final class FourthViewController: UIViewController {
    ...
    private let imageProfile = UIImageView().createImage(image: "mask4", value: nil, borderColor: nil, width: 0, contentMode: .scaleAspectFill)
    private let descriptionLabel = UILabel().createLabel(text: "Не следует, однако, забывать о том, что постоянное информационно-техническое обеспечение нашей деятельности создаёт предпосылки качественно новых шагов для всесторонне сбалансированных нововведений.", size: 15, weight: .semibold, color: .white)
