...
final class SecondPostViewController: UIViewController {

    private let imageProfile = UIImageView().createImage(image: "mask2", value: nil, borderColor: nil, width: 0, contentMode: .scaleAspectFill)
    private let descriptionLabel = UILabel().createLabel(text: "Дорогие друзья, новая модель организационной деятельности требует от нас системного анализа дальнейших направлений развитая системы массового участия!", size: 15, weight: .semibold, color: .white)
