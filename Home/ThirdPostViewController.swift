//
//  ThirdPostsViewController.swift
//  Home
//
...
final class ThirdPostViewController: UIViewController {
    
    private let imageProfile = UIImageView().createImage(image: "mask3", value: nil, borderColor: nil, width: 0, contentMode: .scaleAspectFill)
    private let descriptionLabel = UILabel().createLabel(text: "С другой стороны дальнейшее развитие различных форм деятельности позволяет выполнить важнейшие задания по разработке соответствующих условий активизации?", size: 15, weight: .semibold, color: .white)
